# Contributing to Zero Bounce iOS SDK
...
Open an [issue](https://github.com/zerobounce/zero-bounce-ios-sdk/issues) and include:

* Environment details (Xcode version, iOS version)
* Steps to reproduce
